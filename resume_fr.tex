...
\begin{itemize}
  ...
  \begin{itemize*}
    \item
    Cours pertinent pris : langages de programmation, routage et
...
\begin{itemize}
  ...
  \begin{itemize*}
    \item
    Préparation du rayon, service client.
  \end{itemize*}
  \item
  \headerrow
  ...
  \begin{itemize*}
    \item
    Montage, démontage de concerts en plein air.
    \item
    Maniement de la console lumière.
    \item
    Maintenance lumière et plateau.
  \end{itemize*}
\end{itemize}
